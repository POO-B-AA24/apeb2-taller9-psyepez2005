...
class CuentaBancaria { // esta clase se usa mas como una libreria de metodos
...
class CuentaAhorros extends CuentaBancaria {
   ...
   @Override        //en este tipo de cuenta se reescribe el metodo de retirar por tener diferentes condiciones
    public void retirar(double cantidad) {
